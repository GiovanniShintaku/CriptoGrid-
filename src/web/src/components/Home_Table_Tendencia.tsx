...
export default function HomeTrendTable({ filters }: Props) {
    ...
    useEffect(() => {
        const fetchCoins = async () => {
            try {
                ...
                // Ordena por tendência (maior variação positiva nas últimas 24h)
    ...
    const filteredCoins = coins
        ...
        .sort((a, b) => {
            ...
            return mult * ((a.price_change_percentage_24h ?? 0) - (b.price_change_percentage_24h ?? 0));
        });
    ...
    return (
        <div className="text-white font-[var(--font-body)] w-full flex flex-col items-center">
